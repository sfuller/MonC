...
namespace MonC.LLVM
{
    public sealed class DIBuilder : IDisposable
    {
        ...
        public Metadata CreateCompileUnit(
            ...
            CAPI.DI.LLVMDIBuilderCreateCompileUnit(_builder, lang, fileRef, producer, isOptimized, flags,
        ...
        public Metadata CreateBasicType(string name, ulong sizeInBits, CAPI.DI.LLVMDWARFTypeEncoding encoding,
            ...
            new Metadata(CAPI.DI.LLVMDIBuilderCreateBasicType(_builder, name, sizeInBits, encoding, flags));
        ...
        public Metadata CreateStructType(Metadata scope, string name, Metadata file, uint lineNumber, ulong sizeInBits,
            ...
            new Metadata(CAPI.DI.LLVMDIBuilderCreateStructType(_builder, scope, name, file, lineNumber,
        ...
        public Metadata CreateSubroutineType(
            ...
            new Metadata(CAPI.DI.LLVMDIBuilderCreateSubroutineType(_builder, file,
        ...
        public Metadata CreateReplaceableCompositeType(CAPI.DI.LLVMDWARFTag tag, string name, Metadata scope,
            ...
            new Metadata(CAPI.DI.LLVMDIBuilderCreateReplaceableCompositeType(_builder, tag, name, scope, file,
        ...
        public Metadata CreatePointerType(Metadata pointeeTy, ulong sizeInBits, uint alignInBits, uint addressSpace = 0,
            string name = "") =>
            new Metadata(CAPI.DI.LLVMDIBuilderCreatePointerType(_builder, pointeeTy, sizeInBits, alignInBits,
                addressSpace, name));
        ...
        public Metadata CreateFile(string filename, string directory) =>
            new Metadata(CAPI.DI.LLVMDIBuilderCreateFile(_builder, filename, directory));
        ...
        public Metadata CreateFunction(Metadata scope, string name, string linkageName, Metadata file, uint lineNo,
            ...
            bool isOptimized) =>
            new Metadata(CAPI.DI.LLVMDIBuilderCreateFunction(_builder, scope, name, linkageName, file, lineNo, ty,
        ...
        public Metadata CreateEnumerator(string name, long value, bool isUnsigned) =>
            new Metadata(CAPI.DI.LLVMDIBuilderCreateEnumerator(_builder, name, value, isUnsigned));
        ...
        public Metadata CreateEnumerationType(Metadata scope, string name, UIntPtr nameLen, Metadata file,
            ...
            Metadata classTy) =>
            new Metadata(CAPI.DI.LLVMDIBuilderCreateEnumerationType(_builder, scope, name, file,
        ...
        public Metadata CreateExpression(long[] addr) =>
            new Metadata(CAPI.DI.LLVMDIBuilderCreateExpression(_builder, addr));
        ...
        public Metadata CreateAutoVariable(Metadata scope, string name, Metadata file, uint lineNo, Metadata ty,
            ...
            new Metadata(CAPI.DI.LLVMDIBuilderCreateAutoVariable(_builder, scope, name, file, lineNo, ty,
        ...
        public Metadata CreateParameterVariable(Metadata scope, string name, uint argNo, Metadata file, uint lineNo,
            ...
            new Metadata(CAPI.DI.LLVMDIBuilderCreateParameterVariable(_builder, scope, name, argNo, file, lineNo,
